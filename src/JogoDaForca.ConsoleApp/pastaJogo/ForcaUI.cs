...
internal class ForcaUI
{
    ...
    public void ExibirLetrasErradas(List<char> letrasErradas)
    {
        ...
        foreach (var letra in letrasErradas) Console.Write(letra + " ");
        Console.WriteLine();
    }
    ...
    public void ExibirLetrasCorretas(List<char> letrasCorretas)
    {
        ...
        foreach (var letra in letrasCorretas) Console.Write(letra + " ");
        Console.WriteLine();
    }
    ...
    public char ObterPalpite()
    {
        ...
        var palpite = char.Parse(Console.ReadLine().ToUpper());
        return palpite;
    }
